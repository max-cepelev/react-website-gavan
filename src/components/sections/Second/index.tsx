    ...
    <section className="second">
      <div className="second__container container">
        ...
        <div className="second__text">
          ...
          <p className="text">
            Дом Гавань уникален своей камерностью. Всего 1 подъезд и 6 этажей.
          </p>
          <p className="text">
            Это дом для немногих. Для тех, кто ценит свое личное пространство и
            делает свою жизнь максимально комфортной, отдавая приоритет своим
            собственным, личным интересам.
          </p>
          <a href="#plans">
