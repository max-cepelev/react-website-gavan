            ...
            <div className="capital__container container">
                <div className='capital__text'>
                    ...
                    <ul className="text">
                        ...
                        <li>Бизнес-встречи в конференц-залах Four Elements или Артик-холле</li>
                    </ul>
                </div>
                ...
                <div className='capital__block'>
                    <div>
                        <p>Одним словом, Вы в центре Балатово, а значит, на расстоянии вытянутой  руки все, за что мы любим город.</p>
                    </div>
                </div>
            </div>
        </section>
