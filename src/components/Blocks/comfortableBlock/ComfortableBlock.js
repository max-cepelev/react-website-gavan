        ...
        <section className="comfortable">
            <div className="comfortable__container container">
                ...
                <div className='comfortable__text'>
                    ...
                    <p className='text'>Не волнуйтесь, что придется искать свободное место для машины. В Гавани есть подземный паркинг на 21 автомобиль, а также открытая парковка со стороны улицы 2-я Теплогорская.</p>
